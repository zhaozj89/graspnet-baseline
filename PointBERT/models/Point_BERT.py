...
class PointTransformer(nn.Module):
    def __init__(self, config, **kwargs):
        ...
        # self.dreduce_dim = nn.Linear(self.trans_dim, self.encoder_dims)
    ...
    def forward(self, pts):
        ...
        # neighborhood, center, center_idx = self.group_divider(pts)
        ...
        # # x = self.dreduce_dim(x)
        # return ret.permute(0, 2, 1), center, center_idx
        ...
        x = self.cls_head_finetune(f_level_0.permute(0, 2, 1))
        x = x.permute(0, 2, 1)
        return x, pts
